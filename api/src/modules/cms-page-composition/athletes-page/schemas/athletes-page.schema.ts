...
export type AthletesPageDocument = HydratedDocument<AthletesPage>;
 ...
 *  for the public Athletes listing page: the board defines exactly the shared
 ...
 *
 *  Singleton — at most one row, enforced in `AthletesPageService` (confirmed
...
@Schema({ collection: 'athletesPage', timestamps: true })
export class AthletesPage extends HeroPageSchema {}

export const AthletesPageSchema = SchemaFactory.createForClass(AthletesPage);

...
export type NewsPageDocument = HydratedDocument<NewsPage>;
 ...
 *  for the public News listing page: the board defines exactly the shared
 ...
 *
 *  Singleton — at most one row, enforced in `NewsPageService` (confirmed

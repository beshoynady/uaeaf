 ...
 *
 * `GET /albums/public/:slug` resolves one album by slug; there is no public list to build an index from.
 *
...
export default async function AlbumsPage({ params }: { params: Promise<{ locale: AppLocale }> }) {
  const { locale } = await params;

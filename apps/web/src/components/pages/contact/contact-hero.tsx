 ...
 *
 * Not yet the kit's `InfoCard`: that guard reads this `CARD` declaration, and
 * moving the cards onto the kit means retargeting it at the kit's `raised`
 * plate first (reported with the Brand UI Kit conversion, 2026-09-25).
 */

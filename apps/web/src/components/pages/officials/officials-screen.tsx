...
/**
 * Officials, in preparation (`PREPARING_PAGES`), on `@uaeaf/brand-ui`.
 *
 * There is no public read for officials yet, so there is no directory to list:
 * no cards, no search, no filter chips and no count band.
 *
 ...
 */
export const OfficialsScreen = async ({ locale }: { locale: AppLocale }) => {

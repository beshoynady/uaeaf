...
import { EDITORIAL_ERROR_CODES, HERO_ERROR_CODES, WRITE_ERROR_CODES } from "./admin-write";
...
const SURFACES = [
  ...
  { namespace: "WriteErrors", prefix: "", codes: [...WRITE_ERROR_CODES, ...EDITORIAL_ERROR_CODES, ...HERO_ERROR_CODES] },

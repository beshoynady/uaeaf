...
| `TMP-STATICPAGE-001`                      | Static Pages (About the Federation, Privacy Policy, Regulations) | Chapter 13 §CT-PAGE-001. **Board of Directors instance (ADR-0046):** additionally composes Chapter 8 L8 §CMP-BOARDMEMBERCARD-001 (Chairman feature + Board Grid, backed by §CT-BOARDMEMBER-001) and reuses the existing "الحوكمة والاستراتيجية" flyout destinations as an in-page governance-links section — no new components or IA introduced beyond ADR-0045/0046. **Policies & Regulations instance (ADR-0048):** additionally composes Chapter 8 L8 §CMP-DOCUMENTCARD-001 in a Document Library (search + type filters, Chapter 11 §PT-SEARCH-001/§PT-FILTER-001, reused not invented) backed by §CT-GOVDOCUMENT-001; ships with illustrative example documents pending real CMS records (ADR-0048 Risks). |

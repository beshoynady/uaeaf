...
| **Retention** | Owner decision 2026-09-26 (Q1): **no deletion, and no deletion mechanism built.** The retention period is made "explicitly defined", as Chapter 17 §3 requires, by a named annual review — a Super Admin together with the Federation's data officer, recorded as an `auditLogs` entry of its own. Full terms in **Chapter 17 §3a**. |

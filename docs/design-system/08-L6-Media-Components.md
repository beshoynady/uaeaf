...
# CMP-ALBUMDECK-001 — Featured Album Deck
...
**Purpose:** A fanned preview of an album's first images, shown inside an album card, so a card communicates "a set" rather than "one picture".

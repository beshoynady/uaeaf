...
## ٣. المحتوى الناقص من العميل — **مانع نشر قائم**

السجل الحقيقي يحمل علامتَي `[[pending-content]]`:

| الحقل | الموضع |
|---|---|
| `pullQuote.en` | الاقتباس المميَّز، النسخة الإنجليزية |
| `messageBody.en` | الفقرة الخامسة من النص الإنجليزي (`content[4]`) |

موثَّقتان في `api/src/modules/workflow/publishing/pending-content.ts` وفي
`docs/design-specs/page-president-message.md` §7.5-6.

**الأثر:** `findPublishBlockers` يرفض النشر **والإرسال للمراجعة** ما دامتا قائمتين،
فالسجل لا يملك أي إصدار مجمَّد — الإصدارات تُجمَّد عند النشر وعند الإرسال، لا عند
الحفظ. ولذلك تعرض لوحة الإصدارات «لا إصدارات بعد» على السجل الحقيقي، **وهذا سلوك
صحيح لا عطل**.

**قرار المالك 2026-09-12:** تُترك كما هي (الخيار ج). النص يُطلب من العميل ولا
يُؤلَّف — نصّ مُختلَق في خطاب موقَّع باسم رئيس الاتحاد أسوأ من فجوة ظاهرة.

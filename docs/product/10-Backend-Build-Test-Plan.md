...
- [ ] Domain 2: `clubs`, `athletes`, `athleteProfiles`, `coaches`, `officials`, `officialProfiles`, `venues`, `countries`, `clubTeams`, and the `*History` collections
- [ ] Domain 3 (partial): `disciplines`, `ageCategories` only — **no championships/results/records**
- [ ] Domain 5: Media Center
- [ ] Domain 6: Documents
